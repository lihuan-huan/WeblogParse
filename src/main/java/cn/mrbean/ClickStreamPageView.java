...
public class ClickStreamPageView extends Configured implements Tool {
	...
	/*	String inputPath="hdfs://hadoop100:8020/weblog/"+DateUtil.getYestDate()+"/weblogPreOut";
        ...
        job.setInputFormatClass(TextInputFormat.class);
        job.setOutputFormatClass(TextOutputFormat.class);
        TextInputFormat.addInputPath(job, new Path("hdfs://192.168.136.111:8020/weblog/part-m"));
        TextOutputFormat.setOutputPath(job, new Path("hdfs://192.168.136.111:8020/weblog/pageViewOut2"));
